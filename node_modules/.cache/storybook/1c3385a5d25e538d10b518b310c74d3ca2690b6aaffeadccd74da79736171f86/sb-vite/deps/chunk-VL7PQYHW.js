...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function")
    ...
    let deprecatedTestUtils = await import("./test-utils-RAK3DZXL.js");
    reactAct = ((_a = deprecatedTestUtils == null ? void 0 : deprecatedTestUtils.default) == null ? void 0 : _a.act) ?? deprecatedTestUtils.act;
  }
  return false ? (cb) => cb() : withGlobalActEnvironment(reactAct);
};
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./react-ZMZXHCR3.js"), act = await getAct();
...
//# sourceMappingURL=chunk-VL7PQYHW.js.map
